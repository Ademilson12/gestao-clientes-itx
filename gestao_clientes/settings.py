...
default_dburl = 'sqlite:///' + os.path.join(BASE_DIR, 'db.sqlite3') # Caso não encontre banco de dados ele vai usar o sqlite3 local

DATABASES = { 
    'default': config('DATABASE_URL', default=default_dburl, cast=dburl),
    } # Caso encontre outro ele utiliza o encontrado
...
MEDIA_URL='/media/' # Endereço da pasta

MEDIA_ROOT='media' # Pasta em que deve ser salva
